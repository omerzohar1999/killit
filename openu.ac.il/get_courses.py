...
def get_courses(academic_year: str):
    ...
    parameters = '&Degree=0&GeographicalArea=,01,02,03,04,05,06,07,09,&InstructionHours=00:01&Days=111111' # All possible courses
    ...
    courses_by_semester = []
    print("Now starting access to web")
    for semester in semesters:
        print(f"Started semester {semesters.index(semester) + 1}")
